...
public class Employee {
	...
	/*
	 * We use Getter/Accessor and Setter/Mutator when 
	 * we do not have access to the attributes
	 * when attributes are private (Encapsulated).
	 * It is a safe measure to make our 
	 * attributes/Instance variables
	 * private so that other child/extended/sub-classes 
	 * wont change them.
	 */
