...
public class Person {
	...
	public String getBirthday() { // main method was calling getBirthday which doesn't exist so had to change the
									// name of the getBirthDay to getBirthday
		return birthMonth + "/" + birthDay + "/" + birthYear;
	}

	// Methods to verify ssn and returns boolean
